...
export const TermsAndConditionsLegalDoc = (): JSX.Element => {
  return (
    <div className={styles["container"]}>
      <div
        className={`${styles["container-inner"]} ${fontStyles["body-copy"]}`}
      >
        <div className={styles["header-container"]}>
          <h1 className={fontStyles["title-header"]}>Terms and Conditions</h1>
        ...
        <div>
          ...
          <h3 className={fontStyles["category-header"]}>Interpretation</h3>
          <p>
          ...
          <h3 className={fontStyles["category-header"]}>Definitions</h3>
          ...
          <ul>
            ...
            <li>
              <b>Company</b> (referred to as Country refers to: Delaware, United
              States either &quot;the Company&quot;, &quot;We&quot;,
              &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
              BetterSum, Inc., 480 John Wesley Dobbs Ave NE 411 Atlanta, GA
              30312.
            </li>
            <li>
            ...
            <li>
              <b>Service</b> refers to the Website Terms and Conditions
              Generator.
            </li>
            <li>
            ...
            <li>
              <b>Website</b> refers to BetterSum, accessible from
              https://bettersum.com/.
            </li>
            <li>
        ...
        <div>
          <h2 className={fontStyles["category-header"]}>Acknowledgment</h2>
          <p>
        ...
        <div>
          <h2 className={fontStyles["category-header"]}>Termination</h2>
          <p>
        ...
        <div>
          <h2 className={fontStyles["category-header"]}>Governing Law</h2>
          <p>
        ...
        <div>
          <h2 className={fontStyles["category-header"]}>Disputes Resolution</h2>
          <p>
        ...
        <div>
          ...
          <h3 className={fontStyles["category-header"]}>Severability</h3>
          <p>
          ...
          <h3 className={fontStyles["category-header"]}>Waiver</h3>
          <p>
        ...
        <div>
          <h2 className={fontStyles["category-header"]}>Contact Us</h2>
          <p>
          ...
          <ul>
            <li>
              By email:{" "}
              <a href="mailto:team@bettersum.com">
